...
namespace SailTracker.WebApi.Middlewares
{
    public class MaintenanceMiddleware
    {
        ...
        public MaintenanceMiddleware(RequestDelegate next) // Yazım hatası düzeltildi
        {
            _next = next;
        }
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            bool maintenanceMode = settingService.GetMaintenanceState(); // Yazım hatası düzeltildi
